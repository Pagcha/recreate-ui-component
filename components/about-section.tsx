...
export function AboutSection() {
  ...
  return (
    <section ref={ref} id="about" aria-labelledby="about-heading" className="border-b border-red-500/80 bg-white">
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:py-16">
        <h2
          id="about-heading"
          className="mb-8 text-center text-2xl font-black text-neutral-900 sm:text-3xl"
        >
          О нас
        </h2>

        <div className="grid gap-6 lg:grid-cols-2 lg:items-stretch">
          <div className="flex items-center rounded-3xl border border-red-200 bg-neutral-100 p-6 shadow-[0_18px_40px_rgba(17,17,17,0.05)] sm:p-8">
          ...
          <div className="relative min-h-64 overflow-hidden rounded-3xl border border-red-200 bg-neutral-100 shadow-[0_18px_40px_rgba(17,17,17,0.08)]">
            <Image
